...
export const STEPS = [
  ...
  { id: 'mission', short: 'Misión final', title: 'Demuestra que seguiste la información', question: '¿Puedes explicar la ruta sin memorizar dibujos?', object: '5 PREGUNTAS · CUADERNO', evidence: 'ACTIVIDAD DE CIERRE', rule: 'Una buena respuesta conecta estructura, proceso y función usando evidencias de más de una estación.', explanation: 'Vuelve a las estaciones que necesites y responde con tus propias palabras. No se trata de copiar definiciones: cada pregunta pide relacionar lo que viste.', observe: 'Escribe las cinco respuestas en tu cuaderno e indica qué estación usaste como evidencia.' },
] as const
